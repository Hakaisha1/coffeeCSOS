...
class Riwayat(models.Model):
    ...
    pesanan = models.JSONField(null=True, blank=True)  # simpan cart sebagai JSON
    timestamp = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        # ganti self.jenis dengan info lain, misal total_belanja
...
class MenuItemBahan(models.Model):
    ...
    barang = models.ForeignKey('logistik.Barang', on_delete=models.PROTECT)
    jumlah_dibutuhkan = models.IntegerField(default=1)  # Berapa unit per porsi
