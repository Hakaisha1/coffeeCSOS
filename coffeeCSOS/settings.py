"""
Django settings for coffeeCSOS project.
...
WSGI_APPLICATION = 'coffeeCSOS.wsgi.application'
...
PASSWORD_HASHERS = [
    ...
    'django.contrib.auth.hashers.PBKDF2PasswordHasher',  # Fallback untuk existing passwords
